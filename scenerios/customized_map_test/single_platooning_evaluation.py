...
def arg_parse():
    ...
    parser.add_argument("--max_break", type=float, default=0.7, help='Maximum break, in range 0-1')
    parser.add_argument("--stage_duration", type=float, default=10.0, help='duration for each stage')
